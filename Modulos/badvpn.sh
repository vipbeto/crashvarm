...
fun_udp1 () {
    ...
    menu
	    ...
	    inst_udp () {
            ...
            wget https://raw.githubusercontent.com/vipbeto/crashvarm/main/lib/badvpn-udpgw -o /dev/null
			wget https://raw.githubusercontent.com/vipbeto/crashvarm/main/Modulos/antCrashARM.sh -o /dev/null
