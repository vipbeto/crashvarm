...
fun_botOnOff() {
    [[ $(ps x | grep "bot_plus" | grep -v grep | wc -l) = '0' ]] && {
        ...
        fun_bot1() {
            [[ ! -e "/etc/CrashARM/ShellBot.sh" ]] && wget https://raw.githubusercontent.com/vipbeto/crashvarm/main/ShellBot.sh -O /etc/CrashARM/ShellBot.sh
            cd /etc/CrashARM
			rm -R bot
			wget https://raw.githubusercontent.com/vipbeto/crashvarm/main/Modulos/bot
			chmod 777 bot
